		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#proyectofinal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"proyectofinal-display": {
								"semanticObject": "proyectofinal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=proyectofinal",
									"url": sap.ui.require.toUrl("proyectofinal")
								}
							}
						}
					}
